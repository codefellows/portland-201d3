...
Your grade for labwork today include the items listed below and in lab-assignment.md in the same folder as this file.
...
- Copy-and-paste your code into the big input field for each Gist.
